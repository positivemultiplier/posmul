...
- [🌟 주요 섹션 1](mdc:#-주요-섹션-1)
  - [하위 섹션 1-1](mdc:#하위-섹션-1-1)
  - [하위 섹션 1-2](mdc:#하위-섹션-1-2)
- [🔧 주요 섹션 2](mdc:#-주요-섹션-2)
- [📊 주요 섹션 3](mdc:#-주요-섹션-3)
- [🎯 결론 및 다음 단계](mdc:#-결론-및-다음-단계)
```
...
```markdown
- [🎯 해결할 문제](mdc:#-해결할-문제)
- [🛠️ 사전 요구사항](mdc:#️-사전-요구사항)
- [📖 해결 단계](mdc:#-해결-단계)
- [🔍 문제 해결](mdc:#-문제-해결)
- [✅ 완료 체크리스트](mdc:#-완료-체크리스트)
```
...
**Task List 목차 구조:**
```markdown
- [🚀 Phase 1: MVP Development Tasks](mdc:#-phase-1-mvp-development-tasks)
- [🎯 Task 우선순위 매트릭스](mdc:#-task-우선순위-매트릭스)
- [🔄 Task Dependencies Graph](mdc:#-task-dependencies-graph)
- [🎉 MVP 완성 체크리스트](mdc:#-mvp-완성-체크리스트)
```
...
3. 문법 검증: [Mermaid Live Editor](mdc:https:/mermaid.live) 활용
...
- [Mermaid 공식 문서](mdc:https:/mermaid.js.org)
- [Mermaid Live Editor](mdc:https:/mermaid.live) - 실시간 테스트
- [Next.js 15 + Mermaid 호환성 가이드](mdc:https:/nextjs.org/docs/app/guides/mermaid)
- [Mermaid v11 변경사항](mdc:https:/github.com/mermaid-js/mermaid/releases/tag/v11.0.0)
