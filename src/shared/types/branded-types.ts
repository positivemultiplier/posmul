...
export const createTransactionId = (value: string): TransactionId =>
...
export const createSocialLearningIndex = (
  value: number
): SocialLearningIndex => {
  if (value < 0 || value > 1)
...
export const createInformationTransparency = (
  value: number
...
export const createRiskAversionCoefficient = (
  value: number
...
export const unwrapAccuracyScore = (score: AccuracyScore): number =>
  score as number;
export const unwrapSocialLearningIndex = (index: SocialLearningIndex): number =>
  index as number;
export const unwrapInformationTransparency = (
  transparency: InformationTransparency
): number => transparency as number;
export const unwrapAgencyCostScore = (score: AgencyCostScore): number =>
  score as number;
export const unwrapRiskAversionCoefficient = (
  coefficient: RiskAversionCoefficient
): number => coefficient as number;
