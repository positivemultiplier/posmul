    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="text-center py-20">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          예측 게임과 지역 경제 연동을 통해 시민이 직접 참여하는 새로운 민주주의를 경험해보세요.
        </p>
      ...
      <section className="py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">예측 게임</h3>
            <p className="text-gray-600">
              다양한 사회적 이슈에 대한 예측에 참여하고, 정확도에 따라 포인트를 획득하세요.
            </p>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Local League</h3>
            <p className="text-gray-600">
              지역 소상공인과의 거래를 통해 PMC 포인트를 적립하고 지역 경제에 기여하세요.
            </p>
          </Card>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Major League</h3>
            <p className="text-gray-600">
              기업 광고를 시청하고 참여하여 PMP 포인트를 획득하고 의견을 제시하세요.
            </p>
          </Card>
        </div>
      </section>
