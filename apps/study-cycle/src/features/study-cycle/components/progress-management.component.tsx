...
import { UserId } from "../../../types/study-cycle-types";
import { TextbookId } from "../../../types/study-cycle-types";
import { ReadingMetrics, ChapterProgress } from "../../../types/study-cycle-types";
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <select
            ...
            onChange={(e) => setSelectedTextbook((e.target as unknown as { value: string }).value as TextbookId)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {textbookProgress.map((tp) => (
          <Card
            key={tp.textbookId}
            style={{
              backgroundColor: selectedTextbook === tp.textbookId ? '#eff6ff' : '#fff',
              borderColor: selectedTextbook === tp.textbookId ? '#3b82f6' : '#e5e7eb',
              borderWidth: selectedTextbook === tp.textbookId ? 2 : 1,
            }}
          >
          ...
          <Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="text-2xl font-bold text-blue-600">
                  {currentTextbook.metrics.averagePageTime?.toFixed(1) || '0'}분
                </div>
                <div className="text-sm text-gray-600">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-orange-600">
                  {currentTextbook.metrics.averageDifficulty?.toFixed(1) || '0'}/5.0
                </div>
                <div className="text-sm text-gray-600">
                  전체 챕터 기준
                </div>
