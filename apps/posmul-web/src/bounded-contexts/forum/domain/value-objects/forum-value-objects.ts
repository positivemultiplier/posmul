...
import type {
  StatCategory,
  StatisticPeriod,
} from "../../../demographic-data/domain/value-objects/statistics-value-objects";
...
export const createActivityPoints = (
  amount: number,
...
export { StatCategory, PeriodType, createStatisticPeriod } from "../../../demographic-data/domain/value-objects/statistics-value-objects";

export type { StatisticPeriod } from "../../../demographic-data/domain/value-objects/statistics-value-objects";
