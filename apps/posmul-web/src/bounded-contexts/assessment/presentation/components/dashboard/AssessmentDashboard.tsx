    ...
    <div className="bg-white shadow-lg rounded-lg p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 text-center">
        ...
        <div className="bg-yellow-100 p-4 rounded-lg">
          ...
          <p className="text-3xl font-bold text-yellow-900">{initialData.percentage.toFixed(1)}%</p>
        </div>
        <div className="bg-purple-100 p-4 rounded-lg">
          <p className="text-sm text-purple-700 font-semibold">Time Taken</p>
          <p className="text-3xl font-bold text-purple-900">{Math.round(initialData.timeTakenInSeconds / 60)} min</p>
        </div>
      </div>
