...
export class MerchantApplicationService {
  ...
  async getMerchants(
    ...
    try {
      ...
      return {
        success: false,
        error: error instanceof Error ? error : new Error('상점 목록 조회 중 오류가 발생했습니다.')
      };
    }
  }
  ...
  async getMerchantById(
    ...
    try {
      const merchantIdResult = await import('../../domain/value-objects/investment-value-objects')
      ...
      return {
        success: false,
        error: error instanceof Error ? error : new Error('상점 조회 중 오류가 발생했습니다.')
      };
    }
  }
  ...
  async searchMerchants(
    ...
    try {
      ...
      return {
        success: false,
        error: error instanceof Error ? error : new Error('상점 검색 중 오류가 발생했습니다.')
      };
    }
  }
}
