...
export const CreateAdvertisementRequestSchema = z.object({
  ...
  maxViews: z.number().min(1, '최대 시청 횟수는 1회 이상이어야 합니다').optional()
});

export const UpdateAdvertisementRequestSchema = CreateAdvertisementRequestSchema.partial().extend({
...
// 타입 추론
export type CreateAdvertisementRequest = z.infer<typeof CreateAdvertisementRequestSchema>;
export type UpdateAdvertisementRequest = z.infer<typeof UpdateAdvertisementRequestSchema>;
export type AdvertisementListRequest = z.infer<typeof AdvertisementListRequestSchema>;
export type WatchAdvertisementRequest = z.infer<typeof WatchAdvertisementRequestSchema>;
...
export type WatchAdvertisementResponse = z.infer<typeof WatchAdvertisementResponseSchema>;
