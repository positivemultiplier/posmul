...
export interface IOpinionLeaderRepository {
  ...
  // 검색 및 필터링
  findAll(pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  findByCategory(category: SupportCategory, pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  findByStatus(status: OpinionLeaderStatus, pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  findByVerificationStatus(status: VerificationStatus, pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  ...
  // 이름으로 검색
  searchByName(namePattern: string, pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;

  // 활성 오피니언 리더 조회
  findActiveLeaders(pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  findVerifiedLeaders(pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;

  // 카테고리별 조회
  findByCategories(categories: SupportCategory[], pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  ...
  countByVerificationStatus(status: VerificationStatus): Promise<Result<number>>;
  ...
  // 검증 대기 리더들
  getPendingVerification(pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
  ...
  // 대시보드용 요약
  getAdminSummary(): Promise<Result<{
    totalLeaders: number;
  ...
  // 사용자별 팔로우한 리더들
  findFollowedLeaders(userId: UserId, pagination?: PaginationParams): Promise<Result<PaginatedResult<OpinionLeader>>>;
