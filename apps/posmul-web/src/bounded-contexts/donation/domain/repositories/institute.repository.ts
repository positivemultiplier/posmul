...
import { InstituteId, InstituteCategory } from '../value-objects/donation-value-objects';
...
export interface IInstituteRepository {
  ...
  // 검색 및 필터링
  findAll(pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  findByCategory(category: InstituteCategory, pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  findByStatus(status: InstituteStatus, pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  findByTrustLevel(trustLevel: TrustLevel, pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  ...
  searchByName(namePattern: string, pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;

  // 활성 기관 조회
  findActiveInstitutes(pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  findVerifiedInstitutes(pagination?: PaginationParams): Promise<Result<PaginatedResult<Institute>>>;
  ...
  // 등록번호로 검증
  findByRegistrationNumber(registrationNumber: string): Promise<Result<Institute | null>>;
