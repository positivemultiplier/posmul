...
export default function DashboardError({
  ...
  const enhancedError = (() => {
    ...
    if (message.includes("chart") || message.includes("data visualization") || message.includes("graph")) {
    ...
    if (message.includes("economic") || message.includes("pmp") || message.includes("pmc") || message.includes("balance")) {
      return new BusinessLogicError(
      ...
      <BaseErrorUI
        ...
        customActions={[
          ...(enhancedError instanceof AuthenticationError
            ...
            : []),
          ...(enhancedError instanceof BusinessLogicError && enhancedError.code === "ECONOMIC_DATA_ERROR"
            ? [
                {
                  label: "경제 활동 하기",
