...
export function InstituteDetailClient({
  ...
  const [activeTab, setActiveTab] = useState<"info" | "impact" | "transparency">("info");
      ...
      <div className={`bg-gradient-to-r ${institute.categoryColor} text-white`}>
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <nav className="mb-6 text-white/80 text-sm">
            <Link href="/donation" className="hover:text-white">기부</Link>
            <span className="mx-2">›</span>
            <Link href="/donation/institute" className="hover:text-white">기관 기부</Link>
            <span className="mx-2">›</span>
                ...
                <div>
                  <div className="text-2xl font-bold">
                    {stats.totalDonations > 0 
                      ? Math.floor(stats.totalAmount / stats.totalDonations).toLocaleString()
                      : 0}
                  </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 rounded-xl p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-pink-600 dark:text-pink-400">
                          {Math.floor(stats.totalAmount / 10000)}
                        </div>
                      ...
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                          {Math.floor(stats.totalAmount / 5000)}
                        </div>
                      ...
                      <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                          {Math.floor(stats.totalAmount / 20000)}
                        </div>
                      ...
                      <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl p-4 text-center">
                        ...
                        <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">
                          {Math.floor(stats.totalAmount / 100000)}
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {transparencyReports.length > 0 ? (
                      <div className="space-y-6">
                        {transparencyReports.map((report) => (
                          <div key={report.id} className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 space-y-4">
                            {/* 보고서 기간 */}
                            ...
                            {/* 사용 내역 비율 */}
                            {Object.keys(report.usageBreakdown).length > 0 && (
                              <div>
                                <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                                  사용 내역 비율
                                </h5>
                                <div className="space-y-2">
                                  {Object.entries(report.usageBreakdown).map(([category, percentage]) => (
                                    <div key={category}>
                            ...
                            {/* 임팩트 지표 */}
                            {Object.keys(report.impactMetrics).length > 0 && (
                              <div>
                                <h5 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
                                  주요 성과 지표
                                </h5>
                                <div className="grid grid-cols-3 gap-3">
                                  {report.impactMetrics.beneficiaries !== undefined && (
                                    <div className="bg-white dark:bg-gray-800 rounded-lg p-3 text-center">
                                      <div className="text-2xl mb-1">👥</div>
                                      <div className="text-xl font-bold text-gray-900 dark:text-white">
                                        {report.impactMetrics.beneficiaries?.toLocaleString()}
                                      </div>
                                      <div className="text-xs text-gray-500 dark:text-gray-400">수혜자</div>
                                    </div>
                                  )}
                                  {report.impactMetrics.projects !== undefined && (
                                    <div className="bg-white dark:bg-gray-800 rounded-lg p-3 text-center">
                                      <div className="text-2xl mb-1">📋</div>
                                      <div className="text-xl font-bold text-gray-900 dark:text-white">
                                        {report.impactMetrics.projects}
                                      </div>
                                      <div className="text-xs text-gray-500 dark:text-gray-400">프로젝트</div>
                                    </div>
                                  )}
                                  {report.impactMetrics.success_rate !== undefined && (
                                    <div className="bg-white dark:bg-gray-800 rounded-lg p-3 text-center">
                                      <div className="text-2xl mb-1">✨</div>
                                      <div className="text-xl font-bold text-gray-900 dark:text-white">
                                        {report.impactMetrics.success_rate}%
                                      </div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6">
                      ...
                      <div className="space-y-3">
                        {[
                          { label: "재무 투명성", score: Math.min(10, (institute.trustScore * 1.05)) },
                          { label: "사업 효율성", score: Math.min(10, (institute.trustScore * 0.95)) },
                          { label: "거버넌스", score: Math.min(10, (institute.trustScore * 1.02)) },
                          { label: "커뮤니케이션", score: Math.min(10, (institute.trustScore * 0.92)) },
                        ].map((item) => (
                          <div key={item.label}>
                            <div className="flex justify-between text-sm mb-1">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      ...
                      <button
                        onClick={() => setDonationAmount(userPmcBalance)}
                  ...
                  <button
                    ...
                    disabled={isDonating || (isLoggedIn && donationAmount > userPmcBalance) || donationAmount < 100}
                    className={`w-full py-4 rounded-xl font-bold text-lg transition-all ${
                      isDonating || (isLoggedIn && donationAmount > userPmcBalance) || donationAmount < 100
                  ...
                  >
                    {!isLoggedIn ? (
                      ...
                      `${donationAmount.toLocaleString()} PMC 기부하기`
                    )}
                  </button>

                  {/* Warning */}
                  {isLoggedIn && donationAmount > userPmcBalance && (
