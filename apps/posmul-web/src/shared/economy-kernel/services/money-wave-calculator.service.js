...
const MoneyWaveCalculatorService = /** @class */ (function () {
  function MoneyWaveCalculatorService(
    expectedAnnualEbit // 기본값: 100만원
  ) {
    if (expectedAnnualEbit === void 0) {
      expectedAnnualEbit = 1000000;
    }
   ...
   * 중요도와 난이도에 따른 차등 배분
   */
  MoneyWaveCalculatorService.prototype.allocatePrizePoolToGame = function (
    totalDailyPool,
    gameImportanceScore,
    gameEndTime
  ) {
   ...
   */
  MoneyWaveCalculatorService.prototype.calculateBaseAllocationRatio = function (
    importanceScore
  ) {
