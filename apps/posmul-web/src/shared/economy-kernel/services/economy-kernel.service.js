 ...
 */
const EconomyKernelError = /** @class */ (function (_super) {
 ...
 */
const EconomyKernel = /** @class */ (function () {
  /**
   * 외부에서 직접 인스턴스화 방지
   */
  ...
  EconomyKernel.prototype.getPmpBalance = function (userId) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_1;
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to retrieve PMP balance for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_1
                )
              ),
  ...
  EconomyKernel.prototype.getPmcBalance = function (userId) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_2;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            repositoryResult = this.ensureRepository();
          ...
          case 3:
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to retrieve PMC balance for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_2
                )
              ),
  ...
  EconomyKernel.prototype.getPmpAccount = function (userId) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_3;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            repositoryResult = this.ensureRepository();
          ...
          case 3:
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to retrieve PMP account for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_3
                )
              ),
  ...
  EconomyKernel.prototype.getPmcAccount = function (userId) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_4;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            repositoryResult = this.ensureRepository();
          ...
          case 3:
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to retrieve PMC account for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_4
                )
              ),
  ...
  EconomyKernel.prototype.canSpendPmp = function (userId, requiredAmount) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_5;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (requiredAmount <= 0) {
          ...
          case 3:
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to check PMP sufficiency for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_5
                )
              ),
  ...
  EconomyKernel.prototype.canSpendPmc = function (userId, requiredAmount) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_6;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            if (requiredAmount <= 0) {
          ...
          case 3:
            ...
            return [
              ...
              failure(
                new EconomyKernelError(
                  "Failed to check PMC sufficiency for user ".concat(userId),
                  "REPOSITORY_ERROR",
                  error_6
                )
              ),
  ...
  EconomyKernel.prototype.getSystemStats = function () {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, error_7;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            repositoryResult = this.ensureRepository();
  ...
  EconomyKernel.prototype.getBulkPmpBalances = function (userIds) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, balancePromises, balances, error_8;
      const _this = this;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
          ...
          case 1:
            _a.trys.push([1, 3, , 4]);
            balancePromises = userIds.map(function (userId) {
                    ...
                    case 1:
                      ...
                      if (isFailure(balanceResult)) {
                        throw new EconomyKernelError(
                          "Failed to get PMP balance for user "
                            .concat(userId, ": ")
                            .concat(balanceResult.error.message),
                          "REPOSITORY_ERROR",
                          balanceResult.error
                        );
                      }
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              failure(
                error_8 instanceof EconomyKernelError
                  ? error_8
                  : new EconomyKernelError(
  ...
  EconomyKernel.prototype.getBulkPmcBalances = function (userIds) {
    return __awaiter(this, void 0, void 0, function () {
      let repositoryResult, repo, balancePromises, balances, error_9;
      const _this = this;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    ...
                    case 1:
                      ...
                      if (isFailure(balanceResult)) {
                        throw new EconomyKernelError(
                          "Failed to get PMC balance for user "
                            .concat(userId, ": ")
                            .concat(balanceResult.error.message),
                          "REPOSITORY_ERROR",
                          balanceResult.error
          ...
          case 3:
            ...
            return [
              2 /*return*/,
              failure(
                error_9 instanceof EconomyKernelError
                  ? error_9
                  : new EconomyKernelError(
