...
const SupabaseMCPError = /** @class */ (function (_super) {
...
export var handleMCPError = function (error, operation) {
  ...
  if (error instanceof Error) {
    return new SupabaseMCPError(
      "MCP ".concat(operation, " failed: ").concat(error.message),
      "",
      undefined,
      error
    );
  ...
  return new SupabaseMCPError(
    "MCP ".concat(operation, " failed with unknown error"),
    "",
    undefined,
    undefined
  );
...
export var retryMCPOperation = function (operation_1, operationName_1) {
  ...
  return __awaiter(
    void 0,
    __spreadArray([operation_1, operationName_1], args_1, true),
    void 0,
    function (operation, operationName, maxRetries, delay) {
      let lastError, _loop_1, attempt, state_1;
        ...
        switch (_a.label) {
          ...
          case 4:
            throw new SupabaseMCPError(
              "Failed to execute "
                .concat(operationName, " after ")
                .concat(maxRetries, " attempts"),
              "",
              undefined,
              lastError
            );
