 ...
 */
var SupabaseMCPClient = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!(options === null || options === void 0 ? void 0 : options.retry)) return [3 /*break*/, 3];
                        return [4 /*yield*/, retryMCPOperation(operation, "supabase_execute_sql", options.maxRetries || 3)];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3: return [4 /*yield*/, operation()];
                    case 4: return [2 /*return*/, _a.sent()];
                    case 5:
                        error_1 = _a.sent();
                        throw new SupabaseMCPError("Failed to execute SQL query", this.projectId, query, error_1);
     ...
     */
    SupabaseMCPClient.prototype.findPredictionGamesForMoneyWave = function (filters) {
        return __awaiter(this, void 0, void 0, function () {
            var conditions, whereClause, query, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        conditions = [];
                        ...
                        if (filters === null || filters === void 0 ? void 0 : filters.minParticipants) {
                            conditions.push("participant_count >= ".concat(filters.minParticipants));
                        }
                        if (filters === null || filters === void 0 ? void 0 : filters.hasMoneyWave) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            throw new SupabaseMCPError("Failed to find prediction games for MoneyWave", this.projectId, query, result.error);
                        }
    ...
    SupabaseMCPClient.prototype.getEconomicBalance = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        query = "\n      SELECT \n        COALESCE(pmp.balance, 0) as pmp_balance,\n        COALESCE(pmc.balance, 0) as pmc_balance,\n        GREATEST(pmp.updated_at, pmc.updated_at) as last_activity\n      FROM users u\n      LEFT JOIN pmp_accounts pmp ON u.id = pmp.user_id\n      LEFT JOIN pmc_accounts pmc ON u.id = pmc.user_id\n      WHERE u.id = '".concat(userId, "'\n    ");
                        return [4 /*yield*/, this.executeSQL(query, { retry: true })];
                    case 1:
                        result = _b.sent();
                        if (result.error) {
                            throw new SupabaseMCPError("Failed to get economic balance", this.projectId, query, result.error);
                        }
                        data = (_a = result.data) === null || _a === void 0 ? void 0 : _a[0];
                        return [2 /*return*/, {
                                pmpBalance: (data === null || data === void 0 ? void 0 : data.pmp_balance) || 0,
                                pmcBalance: (data === null || data === void 0 ? void 0 : data.pmc_balance) || 0,
                                lastActivity: (data === null || data === void 0 ? void 0 : data.last_activity) || null,
                            }];
                }
            });
        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        result = _b.sent();
                        if (result.error) {
                            throw new SupabaseMCPError("Failed to get economic statistics", this.projectId, query, result.error);
                        }
                        data = (_a = result.data) === null || _a === void 0 ? void 0 : _a[0];
                        return [2 /*return*/, {
                                totalPmpCirculation: (data === null || data === void 0 ? void 0 : data.total_pmp) || 0,
                                totalPmcCirculation: (data === null || data === void 0 ? void 0 : data.total_pmc) || 0,
                                activeGamesWithMoneyWave: (data === null || data === void 0 ? void 0 : data.active_games_with_money_wave) || 0,
                                dailyTransactions: (data === null || data === void 0 ? void 0 : data.daily_transactions) || 0,
                            }];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, mcp_supabase_get_advisors({
                    ...
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            throw new SupabaseMCPError("Failed to run security check", this.projectId, undefined, result.error);
                        }
                        return [2 /*return*/, result.data || []];
                    case 2:
                        error_2 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            throw new SupabaseMCPError("Failed to run performance check", this.projectId, undefined, result.error);
                        }
                        return [2 /*return*/, result.data || []];
                    case 2:
                        error_3 = _a.sent();
 ...
 */
export var mcp_supabase_execute_sql = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var client;
    return __generator(this, function (_a) {
...
export var mcp_supabase_apply_migration = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var client, result, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!(typeof globalThis.mcp_supabase_apply_migration === "function")) return [3 /*break*/, 2];
...
export var mcp_supabase_get_advisors = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                if (!(typeof globalThis.mcp_supabase_get_advisors === "function")) return [3 /*break*/, 2];
...
export var mcp_supabase_list_tables = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var client, schemas, schemaList, query, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!(typeof globalThis.mcp_supabase_list_tables === "function")) return [3 /*break*/, 2];
                return [4 /*yield*/, globalThis.mcp_supabase_list_tables(params)];
            case 1: return [2 /*return*/, _a.sent()];
            case 2:
                client = createSupabaseMCPClient(params.project_id);
                schemas = params.schemas || ["public"];
                schemaList = schemas.map(function (s) { return "'".concat(s, "'"); }).join(",");
                query = "\n      SELECT \n        table_name,\n        table_schema,\n        table_type\n      FROM information_schema.tables \n      WHERE table_schema IN (".concat(schemaList, ")\n      ORDER BY table_schema, table_name\n    ");
