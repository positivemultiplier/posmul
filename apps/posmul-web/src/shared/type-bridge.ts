 ...
 */
import type {
  PredictionGameId as SDKPredictionGameId,
  UserId as SDKUserId,
} from "@posmul/auth-economy-sdk";
import type {
  PredictionGameId as LegacyPredictionGameId,
 ...
 */
export function toLegacyPredictionGameId(
  sdkGameId: SDKPredictionGameId
): LegacyPredictionGameId {
 ...
 */
export function toSDKPredictionGameId(
  legacyGameId: LegacyPredictionGameId
): SDKPredictionGameId {
